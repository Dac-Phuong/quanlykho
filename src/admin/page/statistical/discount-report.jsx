...
const DiscountReport = () => {
    ...
    const columns = [
        ...
        { field: 'day_sell', headerName: 'Ngày bán', minWidth: 110 },
        { field: 'staff', headerName: 'Nhân viên', minWidth: 210 },
        { field: 'customer', headerName: 'Khách hàng' },
        { field: 'price', headerName: 'Đơn giá gốc' },
        { field: 'quantity', headerName: 'Số lượng' },
        { field: 'cpn_discount', headerName: 'CK Cty', minWidth: 110 },
        { field: 'cpn_discount_price', headerName: 'Giá CK Cty', minWidth: 130 },
        { field: 'real_discount', headerName: 'CK thực', minWidth: 70 },
        { field: 'real_discount_price', headerName: 'Giá CK thực', minWidth: 70 },
        { field: 'disparity', headerName: 'Chênh lệch', minWidth: 70 },
        {
            field: 'active',
            headerName: 'Thao tác',
            minWidth: 310,
