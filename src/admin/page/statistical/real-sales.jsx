...
const RealSales = () => {
    ...
    const columns = [
        ...
        { field: 'customer', headerName: 'Khách hàng', flex: 1, minWidth: 100 },
        { field: 'product', headerName: 'Mã hàng', flex: 1, minWidth: 100 },
        { field: 'original_sale_price', headerName: 'Đơn giá', flex: 1, minWidth: 100 },
        { field: 'quantity', headerName: 'Số lượng', minWidth: 110, flex: 1 },
        { field: 'bonus', headerName: 'KM', minWidth: 100, flex: 1 },
        { field: 'discount', headerName: 'CK', minWidth: 70, flex: 1 },
        { field: 'final_price', headerName: 'GC', minWidth: 70, flex: 1 },
        { field: 'thisTTPriceWithBN', headerName: 'Thành tiền(+KM)', minWidth: 150, flex: 1 },
        { field: 'thisTTPriceWithoutBN', headerName: 'Thành tiền', minWidth: 150, flex: 1 },
        {
            field: 'active',
            minWidth: 100,
            headerName: 'Thao tác',
