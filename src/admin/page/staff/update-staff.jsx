...
import { GET_ITEM_STAFF, UPDATE_STAFF_STATUS, EDIT_STAFF, UPDATE_STAFF } from '../../api'
    ...
    const columns = [
        ...
        { field: 'active', headerName: 'Trạng thái', minWidth: 120 },
        {
            ...
            renderCell: (params) => {
                return (
                    <div>
                        <button className='btn btn-button  btn-primary ml-2' onClick={() => setNewId(params?.row?.id)}>
                            sửa
                        </button>
    ...
    return (
        <div className='pcoded-content'>
            ...
            <div className=''>
                ...
                <HeaderComponents label={'Nhân viên'} title={'Sửa nhân viên'} />
