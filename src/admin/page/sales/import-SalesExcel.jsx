      ...
      <div className="">
        ...
        <div className="card m-4">
          ...
          <div className="card-block remove-label">
            ...
            <div className="flex justify-between my-1 w-fll">
              <Autocomplete
                className="w-[49%] max-sm:w-2/4 mt-[8px]  mr-3"
            ...
            <div className="form-group w-[49%] mt-[5px] max-sm:mr-1">
              <TextField
