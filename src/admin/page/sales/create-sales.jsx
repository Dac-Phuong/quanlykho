...
import { useGetDataCreateSales, useGetDataDiscount } from '../../api/useFetchData'
...
export default function CreateSales() {
                ...
                const array = {
                    ...
                    discount:
                        dataDiscount?.list_discount?.find((item) => {
                            return item.product_id == newValue.id && new Date(item.to_date) >= date
                        })?.discount || 0,
                    guarantee: 0
                }
    ...
    const {
        ...
        isLoading: loadings,
        isError: error
    } = useQuery(queryKeydiscount, useGetDataDiscount(queryKeydiscount))
                    ...
                    <div className='card'>
                        ...
                        <div className='card-block remove-label'>
                            <Autocomplete
                                ...
                                clearOnEscape
                                options={newData === null ? (data && data.products ? data.products : []) : newData}
                                                    ...
                                                    <tr key={item?.product_id} className=''>
                                                        ...
                                                        <th>
                                                            <Input
                                                                ...
                                                                name='guarantee'
                                                                onChange={(e) =>
                                                                    handleInputChange(e, item?.product_id, 'guarantee')
                                                                }
                                                                placeholder='12th'
                                                            />
                                                        </th>
                ...
                <div className='w-full lg:col-span-4'>
                    <div className='card'>
                        ...
                        <div className='card-block remove-label'>
                            ...
                            <div className='form-group ' style={{ width: '48%', marginTop: 10 }}>
                                <TextField
