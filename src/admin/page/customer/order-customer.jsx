...
import { UPDATE_SALES_STATUS, DELETE_SALES, GET_SALES_BILL, FILTER_SALES, ORDER_CUSTOMER } from '../../api'
...
export default function OrderCustomer() {
    ...
    const { data, error, isLoading } = useQuery([queryKey, id], () => handleGetListDataOrderCustomer(id))
    useEffect(() => {
        if (data) {
    ...
    return (
        <section className='pcoded-content'>
            ...
            <HeaderComponents label={'Quản lý khách hàng'} title={'Danh sách đơn bán'} />
            <div className='m-4'>
                <div className='card'>
                    ...
                    {newdata.length === 0 ? (
                        ...
                        >
                            <span className='ml-4 mt-4 absolute'>Chưa có thông tin đơn hàng nào!</span>
                            <img
                        ...
                        <div>
                            <div className='p-4 mt-4 flex flex-wrap'>
                                <div className='info-box bg-green hover-expand-effect w-[360px] mr-5'>
                                    ...
                                    <div className='mt-[11px] pl-3 text-[13px]'>
                                        ...
                                        <div className='number'>
                                            {parseFloat(Math.round(data?.totalSales || 0)).toLocaleString('en-US') +
                                                ' VNĐ'}
                                        </div>
                                    </div>
                                </div>
                                <div className='info-box bg-amber hover-expand-effect w-[360px] mr-5'>
                                    ...
                                    <div className='mt-[11px] pl-3 text-[13px]'>
                                        ...
                                        <div className='number'>
                                            {parseFloat(Math.round(data?.total_paids || 0)).toLocaleString('en-US') +
                                                ' VNĐ'}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='p-4'>
                                <div className='flex max-sm:justify-normal flex-wrap '>
                                    <LocalizationProvider className='flex flex-nowrap ' dateAdapter={AdapterDayjs}>
                                        <DatePicker
