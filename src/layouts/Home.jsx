                                                ...
                                                <div className='card-block min-h-[135px]'>
                                                    <div className='row align-items-center'>
                                                        <div className='col-8'>
                                                            ...
                                                            <h6 className='text-muted m-b-0'>Đơn hàng trong tháng</h6>
                                                        </div>
                                                        <div className='col-4'>
                                                            <BsFillCartPlusFill className='ml-auto' size={30} />
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className='col-xl-3 col-md-6'>
                                            <div className='card'>
                                                <div className='card-block min-h-[135px]'>
                                                    <div className='row align-items-center'>
                                                        <div className='col-8'>
                                                            <h4 className='text-c-red'>131,500 VNĐ</h4>
                                                            <h6 className='text-muted m-b-0'>
                                                ...
                                                <div className='card-block min-h-[135px]'>
                                                    <div className='row align-items-center'>
                                                        <div className='col-8'>
                                                            ...
                                                            <h6 className='text-muted m-b-0'>Công nợ nhân viên</h6>
                                                        </div>
                                                        <div className='col-4 text-right'>
                                                            <span className='text-5xl font-medium'>$</span>
                                                        </div>
                                                ...
                                                <div className='card-block min-h-[135px]'>
                                                    <div className='row align-items-center'>
                                                        <div className='col-8'>
                                                            ...
                                                            <h6 className='text-muted m-b-0'>Công nợ khách hàng</h6>
                                                        </div>
                                                        <div className='col-4 text-right'>
                                                            <span className='text-5xl font-medium'>$</span>
                                                        </div>
