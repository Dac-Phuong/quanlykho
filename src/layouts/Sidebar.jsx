      ...
      <div className="pcoded-inner-navbar main-menu">
        ...
        >
          ...
          <SubMenu label="Nhóm hàng" icon={<BsFillBarChartFill size={18} />}>
            <MenuItem component={<Link to="/nhom-hang/them-nhom-hang" />}>
              Thêm nhóm hàng
            </MenuItem>
          ...
          <SubMenu label="Kho" icon={<FaShop size={18} />}>
            <MenuItem component={<Link to="/quan-ly-kho/them-hang-moi" />}>
              Thêm hàng mới
            </MenuItem>
            <MenuItem component={<Link to="/quan-ly-kho/danh-sach-hang" />}>
              Danh sách hàng
            </MenuItem>
            <MenuItem component={<Link to="/quan-ly-kho/them-kho-hang" />}>
              Danh sách kho
            </MenuItem>
          ...
          <SubMenu label=" Nhập hàng" icon={<BsArrowLeftRight size={18} />}>
            <MenuItem component={<Link to="/nhap-kho/nhap-hang" />}>
              Nhập hàng
            </MenuItem>
            <MenuItem component={<Link to="/nhap-kho/nhap-hang-bang-excel" />}>
              Nhập hàng bằng Excel
            </MenuItem>
            <MenuItem component={<Link to="/nhap-kho/danh-sach-nhap-hang" />}>
              Đơn nhập
            </MenuItem>
          </SubMenu>
          ...
          <MenuItem
            ...
            component={<Link to="/nhan-vien/them-nhan-vien" />}
          >
            Nhân viên
          </MenuItem>
