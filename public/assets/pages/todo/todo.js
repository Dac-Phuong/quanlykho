    ...
    if (task == "") {
      ...
      var add_todo = $(
        '<div class="to-do-list" id="' +
          i +
          '"><div className="checkbox-fade fade-in-primary"><label className="check-task"><input type="checkbox" onclick="check_task(' +
          i +
          ')" id="checkbox' +
          i +
          '"><span className="cr"><i className="cr-icon icofont icofont-ui-check txt-primary"></i></span><span>' +
          task +
          '</span></label></div><div className="f-right"><a onclick="delete_todo(' +
          i +
          ');" href="#!" className="delete_todolist"><i className="icofont icofont-ui-delete" ></i></a></div></div>'
      );
      i++;
    ...
    if (saveTask == "") {
      ...
      var add_todo = $(
        '<div class="to-do-label" id="' +
          i +
          '"><div className="checkbox-fade fade-in-primary"><label className="check-task"><input type="checkbox" onclick="check_label(' +
          i +
          ')" id="checkbox' +
          i +
          '"><span className="cr"><i className="cr-icon icofont icofont-ui-check txt-primary"></i></span><span className="task-title-sp">' +
          saveTask +
          '</span><div className="f-right hidden-phone"><i className="icofont icofont-ui-delete delete_todo" onclick="delete_todo(' +
          i +
          ');"></i></div></label></div></div>'
      );
      i++;
